                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" colspan="8" style="font-size: 170%"><b>Angkatan 2015</b>
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($list_mahasiswa->where('tahun_masuk', '2015') as $mahasiswa)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url("show/$mahasiswa->id") }}" class="btn btn-info"><span
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <table id="example3" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" colspan="8" style="font-size: 170%"><b>Angkatan 2016</b>
                                    </th>
                                </tr>
                                <tr>
                                    <th class="text-center"> NIM</th>
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <table id="example4" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" colspan="8" style="font-size: 170%"><b>Angkatan 2017</b>
                                    </th>
                                </tr>
                                <tr>
                                    <th class="text-center"> NIM</th>
                            ...
                            <tbody>
                                @foreach ($list_mahasiswa->where('tahun_masuk', '2017') as $mahasiswa)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($mahasiswa->status_tracing_2 == 0)
                                                <p class="btn btn-danger center"><span class="fa fa-times"></span>
                                                </p>
                                            @endif
                                            @if ($mahasiswa->status_tracing_2 == 1)
                                                <p class="btn btn-success"><span class="fa fa-check"></span> </p>
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <table id="example5" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" colspan="8" style="font-size: 170%"><b>Angkatan
                                            2018</b>
                                    </th>
                                </tr>
                                <tr>
