<x-admin>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" data-parsley-validate="" action="{{ url('admin/mata-kuliah/update', $matakuliah->id) }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <select name="jenis_mk" class="form-control">
                            ...
                            <option value="3" @if ($matakuliah->jenis_mk == '3') selected @endif> Teori - Praktikum
                            </option>
                        </select>
                    </div>
                    <label class="col-md-2 col-form-label text-center"> Jam Teori</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" name="jam_teori"
                            value="{{ $matakuliah->jam_teori }}">
                    </div>
