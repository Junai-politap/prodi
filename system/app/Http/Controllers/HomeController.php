...
class HomeController extends Controller
{
    ...
    public function tracerStudy()
    {
        ...
        $data['list_survei'] = Survei::where('jenis_survei', 'Tracer Study')->get();
        return view('home.pelayanan.tracer_study', $data);
    }
    ...
    public function kepuasanPengguna()
    {
        ...
        $data['list_survei'] = Survei::where('jenis_survei', 'Kepuasan Pengguna')->get();
        return view('home.pelayanan.kepuasan_pengguna', $data);
    }
}
